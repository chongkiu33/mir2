    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
        <div className="bg-white p-4 sm:p-8 rounded-xl shadow-lg w-full max-w-4xl">
            ...
            {orders.length === 0 ? (
                ...
                <div className="flex flex-col gap-4 s,:flex-row sm:justify-between sm:items-center p-4 sm:p-6 border-b border-gray-200">
            ...
            <div className="px-4 py-3 sm:px-6 sm:py-4">
                ...
                <div className="space-y-3 sm:space-y-4">
                    {order.products?.map((product)=>(
                        ...
                        className="flex flex-row sm:flex-row sm:items-center sm:justify-between gap-3 py-2 border-b last:border-b-0"
                        >
